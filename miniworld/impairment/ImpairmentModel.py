...
class ImpairmentModel:
    ...
    def precalculate(self):
        ...
        self._logger.info("precalculating link qualities ...")
        for distance in range(0, sys.maxsize):
            ...
            if not connected:
                ...
                self._logger.info("max_connected_distance: '%s'", self.max_connected_distance)
                break
    ...
    def import_link_quality_model(pn):
        ...
        try:
            ...
            try:
                ...
                if isinstance(clazz, ImpairmentModel.__class__):
                    return clazz
                else:
                    raise ValueError("Class must be a subclass of '%s'" % ImpairmentModel.__class__.__name__)
