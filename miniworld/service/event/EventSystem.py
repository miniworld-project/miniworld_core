...
from miniworld.model.event.Event import Event
from miniworld.model import ResetableInterface
from miniworld.model.event.EventProgressStore import EventProgressStore
from miniworld.model.event.EventSystemStats import EventSystemStats


class EventSystem(collections.UserDict, EventSystemStats, ResetableInterface.ResetableInterface):
    """
    ...
    def event_init(self, event_name, init_ids=None, finish_ids=None):
        ...
        Examples
        --------
        >>> from miniworld.service.event.EventSystem import EventSystem
        >>> from miniworld.util.cli.events.MyCLIEventDisplay import MyCLIEventDisplay
