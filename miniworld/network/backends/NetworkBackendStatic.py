...
from miniworld.network.backends.NetworkBackend import NetworkBackendDummy
...
def NetworkBackendStatic():
    class NetworkBackendStatic(NetworkBackendDummy):
        ...
        def __init__(self, *args, **kwargs):
            ...
            self._core_config_file_parser = CoreConfigFileParser()
        ...
        def get_all_connections(self):
            ...
            with static_lock:
                ...
                for _, core_scenario_path in core_scenarios:
                    connections_dict = self._core_config_file_parser.parse_core_config_file(core_scenario_path)
                ...
                self._logger.info("connections: %s", pformat(all_connections))
