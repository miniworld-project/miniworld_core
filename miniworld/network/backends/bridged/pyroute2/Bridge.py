...
from miniworld.network.backends.bridged.Bridge import Bridge
    ...
    class BridgePyroute2(Bridge):
        ...
        def _start(self, bridge_dev_name=None, switch=False):
            ...
            try:
                ...
                raise NetworkBackendStartError(
                    "Could not create the bridge with name '%s' in hub mode!" % self.bridge_dev_name) from e
            ...
            try:
                ...
                if if_up:
                    if not singletons.network_backend.connection_book_keeper.interface_states[tap_dev_name]:
                        ...
                        singletons.network_backend.connection_book_keeper.interface_states.toggle_state(tap_dev_name,
                                                                                                        if_up)
                ...
                """ % (_if_name, self, check_output(["brctl", "show"]), pformat(Bridge.get_interfaces()),
                       pformat(singletons.network_backend._tap_id_mapping))) from e
