...
from miniworld.network import AbstractSwitch
...
class Bridge(AbstractSwitch.AbstractSwitch, ResetableInterface.ResetableInterface):
...
Interface dump:
%s
""" % (self, pformat(self.get_interfaces()))) from e
