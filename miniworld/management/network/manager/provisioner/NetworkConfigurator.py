...
class NetworkConfigurator:
    ...
    def __init__(self, get_interface_index_fun, nic_prefix=None,
        ...
        if network_timeout is None:
            network_timeout = miniworld.Scenario.scenario_config.get_connectivity_check_timeout()
        if is_connectivity_checks_enabled is None:
            is_connectivity_checks_enabled = miniworld.Scenario.scenario_config.is_connectivity_check_enabled()
        ...
        if base_network_cidr is None:
            base_network_cidr = scenario_config.get_network_configuration_ip_provisioner_base_network_cidr()
        if prefixlen is None:
            prefixlen = scenario_config.get_network_configuration_ip_provisioner_prefixlen()
