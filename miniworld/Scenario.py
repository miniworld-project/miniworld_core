...
class ScenarioConfig(JSONConfig.JSONConfig):
    ...
    @customizable_attrs("network", "links", "configuration", "connectivity_check", "cmd", default='ping -n -c 1 -w {timeout} {ip}')
    ...
    @customizable_attrs("network", "links", "configuration", "ip_provisioner", "base_network_cidr", default=u"10.0.0.0/8")
    ...
    @customizable_attrs("network", "backend", "num_ports",
                        default=miniworld.model.network.backends.vde.VDEConstants.NUM_PORTS)
    def get_network_backend_vde_num_ports(self):
        pass
    ...
    def get_network_backend_cnt_minions(self):
        if scenario_config.is_network_backend_parallel():
    ...
    def is_network_backend_bridged_execution_mode_brctl(self):
        return scenario_config.get_network_backend_bridged_execution_mode() == EXECUTE_MODE_BRCTL

    def is_network_backend_bridged_execution_mode_iproute2(self):
        return scenario_config.get_network_backend_bridged_execution_mode() == EXECUTE_MODE_IPROUTE2

    def is_network_backend_bridged_execution_mode_pyroute2(self):
        return scenario_config.get_network_backend_bridged_execution_mode() == EXECUTE_MODE_PYROUTE2

    def is_network_backend_bridged_connection_mode_single(self):
        return scenario_config.get_network_backend_bridged_connection_mode() == CONNECTION_MODE_SINGLE
    ...
    def is_network_backend_bridged_connection_mode_multi(self):
        ...
        return scenario_config.get_network_backend_bridged_connection_mode() == CONNECTION_MODE_MULTI
