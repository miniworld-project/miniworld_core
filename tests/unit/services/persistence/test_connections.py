...
class TestConnectionPersistenceService:
    ...
    def test_to_domain(self, service: ConnectionPersistenceService, mock_nodes, mock_connections):
        ...
        db_connection.node_x = Node(id=connection.emulation_node_x._node._id)
        db_connection.node_y = Node(id=connection.emulation_node_y._node._id)
        ...
        assert abstract_connection.emulation_node_x._node._id == connection.emulation_node_x._node._id
        assert abstract_connection.emulation_node_y._node._id == connection.emulation_node_y._node._id
